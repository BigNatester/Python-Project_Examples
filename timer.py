...
from playsound import playsound #Will play the sound when the number reaches 0. install using pip install playsound in your command prompt on windows or pip3 install playsound
